...
mod tests {
    ...
    fn part_1_works_on_example() {
        assert_eq!(compute_answer(file!(), part_1, "example"), "35");
    }

    #[test]
    fn part_1_works_on_input() {
        assert_eq!(compute_answer(file!(), part_1, "input"), "5571");
    }

    #[test]
    fn part_2_works_on_example() {
        assert_eq!(compute_answer(file!(), part_2, "example"), "3351");
    }

    #[test]
    fn part_2_works_on_input() {
        assert_eq!(compute_answer(file!(), part_2, "input"), "17965");
    }
}
